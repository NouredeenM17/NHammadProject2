Using the matrix operations library I developed, I read data about flowers from the CSV file, perform matrix operations on it then export the results into the results text file.
